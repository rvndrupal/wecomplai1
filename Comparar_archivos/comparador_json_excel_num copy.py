...
NUMERO_FILAS_VALIDAR = 5000  # Cambiar a None para procesar TODO el archivo
...
FILA_FIN = 5000   # Fila donde terminar (None = hasta el final)

# 📁 RUTAS DE ARCHIVOS
EXCEL_BASE_PATH = "mapeo_completo_01_di_002.xlsx" #EXCEL
JSON_PATH = "01_di_002.json"  # JSON
